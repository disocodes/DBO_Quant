...
# MAGIC %md
# MAGIC # 04 — Monte Carlo
# MAGIC Simulate a portfolio from historical returns. Run after 01_INGEST_DATA. This notebook is independent of backtesting.
...
if prices.empty: raise RuntimeError("No data. Run 01_INGEST_DATA.py first.")
